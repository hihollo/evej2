...
export default {
  ...
  methods: {
    setPointSize (val) {
      this.$store.state.cubeScatterLegend.pointSize = val
      console.log('点的大小设置为')
      console.log(this.$store.state.cubeScatterLegend.pointSize)
    },
    setLabSize (val) {
      this.$store.state.cubeScatterLegend.labSize = val
    },
  ...
  watch: {
    pointType (val) {
      this.$store.state.cubeScatterLegend.symbol = this.pointType
      console.log('设置点类型为')
      console.log(this.pointType)
      console.log(this.$store.state.cubeScatterLegend.symbol)
    },
    backgroundColor (val) {
      console.log('背景颜色设置为')
      this.$store.state.cubeScatterLegend.backgroundColor = val
      console.log(this.$store.state.cubeScatterLegend.backgroundColor)
    },
    pointColor (val) {
      this.$store.state.cubeScatterLegend.pointColor = val
    },
    pointSize (val) {
      this.$store.state.cubeScatterLegend.pointSize = val
    },
    labColor (val) {
      this.$store.state.cubeScatterLegend.labColor = val
    },
    labSize (val) {
      this.$store.state.cubeScatterLegend.labSize = val
    }
